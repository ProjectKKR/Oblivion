...
public class FiniteMoveManager5: FiniteMoveManager {
	...
	public void Reset(){
		targetCoords = new Vector2[N]{new Vector2(2,3),new Vector2(3,4),new Vector2(4,2),new Vector2(4,3),new Vector2(4,5),new Vector2(5,2),new Vector2(6,3)};
		unitCoords = new Vector2[N]{new Vector2(2,3),new Vector2(3,1),new Vector2(4,2),new Vector2(4,4),new Vector2(4,5),new Vector2(5,3),new Vector2(6,2)};
		unitCounts = new int[N]{2,3,1,2,2,1,3};
		Refresh ();
	}
