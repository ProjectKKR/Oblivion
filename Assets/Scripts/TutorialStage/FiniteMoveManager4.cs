...
public class FiniteMoveManager4: FiniteMoveManager {
	...
	public void Reset(){
		targetCoords = new Vector2[N]{new Vector2(2,4),new Vector2(3,3),new Vector2(4,4),new Vector2(5,4),new Vector2(5,5),new Vector2(6,3)};
		unitCoords = new Vector2[N]{new Vector2(3,2),new Vector2(3,3),new Vector2(3,4),new Vector2(5,2),new Vector2(5,3),new Vector2(5,4)};
		unitCounts = new int[N]{2,2,1,3,0,0};
		Refresh ();
	}
