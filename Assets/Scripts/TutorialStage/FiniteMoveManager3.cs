...
public class FiniteMoveManager3: FiniteMoveManager {
	...
	public void Reset(){
		targetCoords = new Vector2[N]{new Vector2(4,3),new Vector2(4,4),new Vector2(5,2),new Vector2(5,3),new Vector2(5,5),new Vector2(6,3),new Vector2(6,4)};
		unitCoords = new Vector2[N]{new Vector2(2,3),new Vector2(3,3),new Vector2(4,2),new Vector2(4,5),new Vector2(5,3),new Vector2(5,4),new Vector2(6,2)};
		unitCounts = new int[N]{2,0,1,2,0,2,1};
		Refresh ();
	}
